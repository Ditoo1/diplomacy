    ...
    if (username.length >= 6 && password.length >= 6) {
        ...
        userRef.once('value', function(snapshot) {
            ...
            if (userData) {
                ...
                userRef.set({ password: password }, function(error) {
                    if (error) {
        ...
        alert('Por favor, ingrese un nombre de usuario y una contraseña con al menos 6 caracteres.');
    }
}

// Separar el inicio de sesión visual en una función
...
function logout() {
    // Eliminar el nombre de usuario y la contraseña del almacenamiento local
